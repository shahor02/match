...
void runCATracking(std::string inputfile="o2clus.root"
		   ,std::string outputfile="o2rec_tpc.root"
		   ,std::string options="cont"
		   ,bool mergeChain = true //false
