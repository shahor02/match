...
void o2sim()
{
  ...
  if (genconfig.compare("boxgen") == 0) {
    ...
    auto boxGen0 = new FairBoxGenerator(211, 20); /*protons*/
    boxGen0->SetEtaRange(-0.9, 0.9);
    boxGen0->SetPRange(0.1, 5);
    boxGen0->SetPhiRange(0., 360.);
    boxGen0->SetDebug(kTRUE);

    auto boxGen1 = new FairBoxGenerator(-211, 20); /*protons*/
    boxGen1->SetEtaRange(-0.9, 0.9);
    boxGen1->SetPRange(0.1, 5);
    boxGen1->SetPhiRange(0., 360.);
    boxGen1->SetDebug(kTRUE);
